{**
 * @file templates/plugins/generic/staticPages/templates/page.tpl
 *
 * Glass Theme — Override for Static Pages plugin
 *}
...
<main id="main-content" class="page-fade">
    ...
    <section class="search-hero" aria-labelledby="static-heading">
        ...
        <div style="position:relative;z-index:1;">
            ...
            <h1 class="section-title" id="static-heading" style="margin:.5rem 0 1.5rem;">
                {$title|escape}
            </h1>
        </div>
    </section>
