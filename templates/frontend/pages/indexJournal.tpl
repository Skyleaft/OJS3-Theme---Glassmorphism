...
<main id="main-content" class="page-fade">
    ...
    <section class="hero" aria-labelledby="hero-heading">
        <div class="hero-bg" aria-hidden="true">
            <img src="{$baseUrl}/plugins/themes/glassTheme/public/images/hero-bg.svg" alt="" loading="lazy">
        </div>
            ...
            <aside class="glass-card hero-journal-card reveal reveal-delay-2"
                ...
                <div class="journal-meta">
                    ...
                    <div class="journal-meta-row">
                        ...
                        <strong>
                            {if $currentJournal->getData('publishingFrequency')}
                                {$currentJournal->getData('publishingFrequency')|escape}
                            {else}
                                {translate key="plugins.themes.glassTheme.frequency.biannual"}
                            {/if}
                        </strong>
                    </div>
                </div>
                ...
                {if $currentIssue}
                    ...
                    <div style="font-size:.9rem;color:var(--glass-text);font-weight:600;line-height:1.4;">
                        {if $currentIssue->getLocalizedTitle()}
                            {$currentIssue->getLocalizedTitle()|escape}
                        {else}
                            Vol. {$currentIssue->getVolume()|escape} No. {$currentIssue->getNumber()|escape}
                            ({$currentIssue->getYear()|escape})
                        {/if}
                    </div>
                {/if}
            </aside>
            ...
            <div class="page-container">
                ...
                <div class="card-grid">
                    {foreach from=$publishedArticles item=article name=articles}
                        ...
                        <article
                            class="glass-card article-card reveal reveal-delay-{$smarty.foreach.articles.index|string_format:"%d" + 1}"
    ...
    {* ── Announcements ─────────────────────────────────────────────────────── *}
    {if $announcements}
        <section class="section" aria-labelledby="announcements-heading" style="padding-top:0;">
            <div class="page-container">
                <div class="section-header reveal">
                    <span class="section-eyebrow">
                        ...
                        <div class="glass-card-sm reveal reveal-delay-{$smarty.foreach.news.index + 1}"
                            ...
                            <h3 style="font-size:.95rem;font-weight:650;color:var(--glass-text);
                                ...
                                <a href="{url router=PKP\core\PKPApplication::ROUTE_PAGE
                                          ...
                                          path=$announcement->getId()}" style="color:inherit;text-decoration:none;">
