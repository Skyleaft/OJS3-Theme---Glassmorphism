    ...
    <div class="footer-grid">
        ...
        <div>
            ...
            <ul class="footer-links">
                <li><a href="{url router=PKP\core\PKPApplication::ROUTE_PAGE page='index'}">{translate key="navigation.homePage"}</a></li>
        ...
        <div>
            ...
            <ul class="footer-links">
                <li><a href="{url router=PKP\core\PKPApplication::ROUTE_PAGE page='about'}">{translate key="about.editorialTeam"}</a></li>
        ...
        <div>
            ...
            <ul class="footer-links">
                {if $isUserLoggedIn}
                    <li><a href="{url router=PKP\core\PKPApplication::ROUTE_PAGE page='user' op='profile'}">{translate key="user.profile"}</a></li>
                    <li><a href="{url router=PKP\core\PKPApplication::ROUTE_PAGE page='submission'}">{translate key="author.submit"}</a></li>
                    <li><a href="{url router=PKP\core\PKPApplication::ROUTE_PAGE page='user' op='logout'}">{translate key="user.logOut"}</a></li>
                {else}
                    <li><a href="{url router=PKP\core\PKPApplication::ROUTE_PAGE page='user' op='login'}">{translate key="user.login"}</a></li>
                    <li><a href="{url router=PKP\core\PKPApplication::ROUTE_PAGE page='user' op='register'}">{translate key="user.register"}</a></li>
                {/if}
            </ul>
        </div>
    </div>
